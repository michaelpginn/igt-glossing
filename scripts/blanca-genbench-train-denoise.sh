...
python3 denoise_gloss_model.py --arch_size full --project genbench-taxo-morph-denoiser --train_data ../data/GenBench/story_advice_personal --eval_data ../data/GenBench/history
