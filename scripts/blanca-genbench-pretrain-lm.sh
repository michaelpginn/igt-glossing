...
python3 pretrain_language_model.py --arch_size full --project genbench-taxo-morph-pretrain --train_data ../data/GenBench/train --eval_data ../data/GenBench/eval_ID --position_embeddings absolute
