...
python3 pretrain_language_model.py --arch_size micro --project genbench-taxo-morph-pretrain --train_data ../data/GenBench/story --eval_data ../data/GenBench/history --position_embeddings relative_key_query
