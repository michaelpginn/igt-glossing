...
python3 finetune_token_classifier.py train --project genbench-taxo-morph-exp1 --model_type no_pretrained --seed 1 --epochs 100 --weight_decay 0 --train_data ../data/GenBench/train --eval_data ../data/GenBench/eval_OOD
